...
from jobstreaming.model import JobType, Location
from jobstreaming.util import get_enum_from_job_type
...
def parse_job_type(soup_job_type: BeautifulSoup) -> list[JobType] | None:
    ...
    if not employment_type:
        return None
    parsed = get_enum_from_job_type(employment_type)
...
def is_job_remote(title: str, description: str | None, location: Location) -> bool:
    """
